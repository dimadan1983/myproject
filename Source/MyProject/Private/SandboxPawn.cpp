...
ASandboxPawn::ASandboxPawn()
{
	...
	SceneComponent = CreateDefaultSubobject<USceneComponent>("SceneComponent");  // создаем компонент сцены
	SetRootComponent(SceneComponent);

	StaticMeshComponent = CreateAbstractDefaultSubobject<UStaticMeshComponent>("StaticMeshComponent");
